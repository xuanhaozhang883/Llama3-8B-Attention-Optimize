# Quick v4 suite: excludes the 65,536-output full Softmax golden test.
set origin_dir [file normalize [file join [file dirname [info script]] ..]]
set project_dir [file join $origin_dir vivado_v4_quick_sim]
set part_name "xc7a35tcpg236-1"

catch {close_sim}
if {[llength [get_projects -quiet]] > 0} { close_project }
create_project fpt_b_v4_quick_sim $project_dir -part $part_name -force
...
foreach f [get_files -quiet *.mem] { set_property file_type {Memory Initialization Files} $f }
...
puts "Quick v4 suite finished. All ten tests must print PASS."
