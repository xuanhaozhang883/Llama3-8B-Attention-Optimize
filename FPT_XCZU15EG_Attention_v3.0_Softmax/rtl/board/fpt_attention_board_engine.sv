...
module fpt_attention_board_engine #(
    ...
    attention_system_with_rope_pv_top #(
        ...
        .active_group_id, .bc_group_done(core_bc_group_done),
        .capture_complete(core_capture_complete),
        .pv_group_done(core_pv_group_done),
        .bc_busy(core_bc_busy), .pv_busy(core_pv_busy),
        .rope_busy(core_rope_busy), .qk_busy(core_qk_busy),
        .mask_busy(core_mask_busy), .softmax_busy(core_softmax_busy),
        .bc_backend_busy(core_bc_backend_busy),
        .capture_busy(core_capture_busy),
