...
# Optimized v2.6 is the source default.  Set FPT_V26_CONFIG=legacy to exercise
# the exact v2.5 structural fallback without editing RTL.
if {[info exists ::env(FPT_V26_CONFIG)] &&
    ...
    puts "Top configuration: v2.5 structural fallback (1/2/1)"
} else {
    set_property generic \
        {QK_LANES=2 CAPTURE_TILE=4 PV_LANES=2} \
        [get_filesets sources_1]
    puts "Top configuration: v2.6 causal dual-tile (2/4/2)"
}
