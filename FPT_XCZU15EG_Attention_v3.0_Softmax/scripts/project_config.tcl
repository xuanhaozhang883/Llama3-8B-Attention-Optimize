...
set fpt_project_name "fpt_attention_board_v26_causal_dualtile"
set fpt_xsa_name "fpt_attention_board_v26_causal_dualtile.xsa"
...
# directory, for example C:/lhm/2_Work/4_FPT/_fpt_v26_build/.
#
# Advanced users may override it before launching Vivado:
#   set ::env(FPT_VIVADO_BUILD_ROOT) C:/fpt_build/v26
...
if {[info exists ::env(FPT_VIVADO_BUILD_ROOT)] &&
    ...
    set fpt_build_root [file normalize \
        [file join [file dirname $fpt_source_root] _fpt_v26_build]]
}
