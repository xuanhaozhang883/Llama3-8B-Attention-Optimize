...
if {[llength $bit_candidates] < 1} {
    error "v2.6 Attention bitstream was not found in export/ or the generated Vivado project"
}
...
dow $app_elf
con
puts {[PASS] Bitstream and ELF started with reduced no-GTR PS initialization; check PS UART at 115200 8N1.}
