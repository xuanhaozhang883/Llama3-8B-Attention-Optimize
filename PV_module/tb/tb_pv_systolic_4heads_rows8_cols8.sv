...
module tb_pv_systolic_4heads_rows8_cols8;

    localparam integer TILE         = 4;
    localparam integer TEST_ROWS    = 8;
    localparam integer TEST_COLS    = 8;
    ...
    initial begin
        ...
        seen_count      = 0;
        last_count      = 0;
        for (init_idx = 0; init_idx < TEST_TOTAL; init_idx = init_idx + 1)
        ...
        if ((seen_count == TEST_TOTAL) && (pass_count == TEST_TOTAL) && (fail_count == 0) && (duplicate_count == 0) && (last_count == 1))
