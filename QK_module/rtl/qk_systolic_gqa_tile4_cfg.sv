...
// 固定为4x4 PE、4Q/1K、SEQ=128、HEAD_DIM=128的综合配置。
// 用于直接查看TILE=4的资源和时序，不包含BRAM/DDR loader。
module qk_systolic_gqa_tile4_cfg (
    input  logic        clk,
    input  logic        rst_n,
    input  logic        start,
    output logic        busy,
    ...
    input  logic [63:0] q_vec_bf16,
    input  logic [63:0] k_vec_bf16,
