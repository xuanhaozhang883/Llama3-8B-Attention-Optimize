...
module tb_qk_systolic_gqa_4heads_seq16;

    localparam int TILE       = 4;
    localparam int TEST_SEQ   = 16;
    ...
    initial begin
        ...
        $display("========================================");
        $display("4-head, seq16, TILE=4 QK test complete");
        ...
        if ((seen_count == TOTAL) &&
            ...
            (duplicate_count == 0) &&
            (last_count == 1))
            $display("[PASS] 4-head seq16 TILE=4 QK matrix");
        else
            $display("[FAIL] 4-head seq16 TILE=4 QK matrix");
        $display("========================================");
    ...
    initial begin
        #80000000;
        $display("========================================");
        $display("[TIMEOUT] seq16 test did not finish");
