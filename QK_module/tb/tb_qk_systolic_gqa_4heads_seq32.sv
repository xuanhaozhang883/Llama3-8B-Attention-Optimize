...
module tb_qk_systolic_gqa_4heads_seq32;
    ...
    initial begin
        ...
        $display("========================================");
        $display("4-head, seq32, TILE=4 QK test complete");
        ...
        if ((seen_count == TOTAL) &&
            ...
            (duplicate_count == 0) &&
            (last_count == 1))
            $display("[PASS] 4-head seq32 TILE=4 QK matrix");
        else
            $display("[FAIL] 4-head seq32 TILE=4 QK matrix");
        $display("========================================");
    ...
    initial begin
        #300000000;
        $display("========================================");
        $display("[TIMEOUT] seq32 test did not finish");
