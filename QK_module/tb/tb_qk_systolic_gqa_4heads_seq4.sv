...
module tb_qk_systolic_gqa_4heads_seq4;
    ...
    initial begin
        ...
        $display("========================================");
        $display("4-head, seq4 GQA systolic matrix test complete");
        ...
        if ((seen_count == Q_HEADS*TEST_SEQ*TEST_SEQ) &&
            (fail_count == 0))
            $display("[PASS] 4-head seq4 systolic QK matrix");
        else
            $display("[FAIL] 4-head seq4 systolic QK matrix");
        $display("========================================");
    ...
    initial begin
        #20000000;
        $display("[TIMEOUT] 4-head seq4 GQA systolic matrix did not finish");
