...
- `NON_BOARD_RECOVERY_2026-09-02.md` 记录当前可重复证据与阻塞；`P2C_ARTIFACT_IDENTITY_CHAIN_2026-09-04.md` 记录匹配 BIT/XSA/ELF 身份链；`BOARD_BRINGUP_TUTORIAL_V314.md` 是后续板级 Gate 的逐步教程。
- `TEAM_4_OPTIMIZATION_PLAN.md` 记录人员边界和合并 Gate。
