...
module tb_cats_r4_a3_full_protocol #(
    ...
    logic q_rsp_valid=0; logic [3:0] q_rsp_context_tag=0; logic [15:0] q_rsp_bf16=0;
    logic k_req_valid,k_req_ready; logic [3:0] k_req_context_tag;
    logic [1:0] k_req_key_block; logic [6:0] k_req_d;
    logic k_rsp_valid=0; logic [3:0] k_rsp_context_tag=0; logic [511:0] k_rsp_vec=0;
    ...
    assign q_req_ready=lfsr[10]||lfsr[14]||lfsr[18];
    assign k_req_ready=lfsr[11]||lfsr[15]||lfsr[19];
    ...
    initial begin
        ...
        for(jobs_sent=0;jobs_sent<256;jobs_sent=jobs_sent+1) begin
        ...
        cycles=0;
        while((outputs<16384||releases<4096||retires<256)&&cycles<12000000) begin
