...
$src=@('cats_r4_qk_row_assembler.sv','cats_r4_qk_ab_handoff.sv','cats_r4_qk_slot_lifecycle.sv','cats_r4_qk_row_abort_arbiter.sv','cats_r4_qk_row_handoff_wrapper.sv')|ForEach-Object{Join-Path $Root "rtl\core\bc\qk\$_"}
